...
<!-- page-local styles -->
<style>
/* hide Minima’s header, nav row, footer, and automatic page title */
...
/* make projects a single vertical column */
...
/* respect manual line breaks inside <p> in cards */
.card p { margin:0 0 10px; white-space:pre-line; }
...
**Research Assistant (Youth Service)**, *Centre for the Study of the Economies of Africa (CSEA)* — Aug 2017–Jul 2018  
...
<div class="card">
  ...
  <p class="small">
The story begins with shelter: My first end-to-end ML project that estimates fair market prices for London properties using over 200k records (Kaggle).
