...
/* page layout */
.hero { display:flex; gap:18px; align-items:flex-start; margin: 0 0 14px; }
/* ⬇️ bigger profile photo */
.hero img { width:220px; height:220px; border-radius:50%; object-fit:cover; }
...
/* Force projects to be vertical on ALL screens */
.grid { display:block; }
.card { display:flex; flex-direction:column; border:1px solid #e5e7eb; border-radius:12px; padding:14px; background:#fff; margin-bottom:18px; }
...
**Awards.**  
• **Best Graduating Student (BSc Economics)** — Bauchi State University, **Class of 2017**  
• **Merit-based Postgraduate Scholarship** — Kaduna State Government, for MSc studies at a university of choice (global)
...
<div class="card">
  ...
  <p class="small">
    ...
    <br><br>
    The app uses official ONS CPIH data, allows users to adjust their spending mix, predicts the 3-month forward personal inflation rate, and flags whether inflation risk is high or low relative to national CPIH.
...
<div class="card">
  ...
  <p class="small">
    After checking personal inflation, the next question is how to spend smarter on food.
    I scraped real product listings from Tesco & Sainsbury’s (captured Nov 2025) and built an app that finds cheaper, similar alternatives across both retailers.
